...
var api = {
  ...
  token: "87d89575cd9f3f8dfdd1f38c8d1f2dac", // TODO 0 add your api key
...
function render() {
  ...
  model.watchlistItems.forEach(function(movie) {
    ...
    var button = $("<button></button>")
        ...
        .click(function() { var index = model.watchlistItems.indexOf(movie);
                            model.watchlistItems.splice(index,1);   // delete the movie from the watchlist and re-render;
                            render();
                          });
